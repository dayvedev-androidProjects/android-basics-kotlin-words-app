...
class LetterListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = binding.root //return inflate view
        return view
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_switch_layout -> {
                ...
                /**
                 * Lifecycle-aware components such as fragments, provide first-class coroutine support for logical
                 * scopes in your app along with an interoperability layer with LiveData.
                 * A LifecycleScope is defined for each Lifecycle object. Any coroutine launched in this scope is
                 * canceled when the Lifecycle owner is destroyed.
                 */
